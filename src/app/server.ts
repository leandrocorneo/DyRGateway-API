...
import serviceTypeRoutes from '../modules/service-types/service-types.route';
...
import routingRoutes from '../modules/routing/routing.route';
...
app.register(serviceTypeRoutes, { prefix: '/api' });
...
app.register(routingRoutes, { prefix: '/api' });
